...
- 2026-09-25：原训练在约2742个 batch 处因 `free(): invalid next size (normal)` 退出；缓存1992/1992完整，step-2400权重已验证可读。A6000脚本默认数据 worker 改为0，并新增 `scripts/resume_wan81_a6000.sh`，通过 `--lora_checkpoint` 从step-2400续训到独立输出目录。
